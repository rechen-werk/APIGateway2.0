...
namespace APIGateway2._0.Models
{
    public class BankAgent : Agent {
        public delegate Task<long> Converter(long price, Currency from, Currency to);
        ...
        public readonly Converter Convert;

        public BankAgent() {}

        public BankAgent(string name, string description, Converter converter) : base(name, description)
        {
            Convert = converter;
        }
